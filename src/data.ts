...
export const teas: TeaData[] = [
    { id: 1, name: "jasmine", caffeine: 0, description: "", functionalities: [3, 4]},
    { id: 2, name: "golden horse eyes", caffeine: 3, description: "", functionalities: [1, 4]},
    { id: 3, name: "long jin", caffeine: 2, description: "", functionalities: [2, 4]},
    { id: 4, name: "pu er", caffeine: 5, description: "", functionalities: [2, 3]},
    { id: 5, name: "british breakfast", caffeine: 8, description: "", functionalities: [1]},
];
